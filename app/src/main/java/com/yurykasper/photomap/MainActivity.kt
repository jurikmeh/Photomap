...
import com.yurykasper.photomap.databinding.ActivityMainBinding
import com.yurykasper.photomap.main.TabsFragment
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getRootNavController(): NavController {
        val navHost = supportFragmentManager.findFragmentById(R.id.loginContainerView) as NavHostFragment
    ...
    private fun isSignedIn(): Boolean {
        val args = intent.extras ?: throw IllegalStateException("No required arguments")
        return args.getBoolean(IS_AUTHORIZED_KEY)
    }
